...
the work performed?
\\\textbf{[Yes]} \Cref{sec:implications} and
...
\Cref{sec:continuous-impossibility,sec:discrete-impossibility,sec:stochastic-multiturn};
expanded proofs are in \Cref{app:full-proofs}; and the formal

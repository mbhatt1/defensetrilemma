...
the discrete dilemma trades \emph{injectivity}. In both cases, a
complete defense must collapse distinct inputs---losing the ability
to distinguish remapped attacks from genuine safe inputs.

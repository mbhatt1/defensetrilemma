...
- **Defense:** `bounded_step` (params: `{'max_step': 12}`)
...
|---|---|---|---|
| Maximum across all filled cells | `249.2134` | `0.4450` | within |
...
✅ **Containment confirmed**: every cell in the predicted steep set (1 cells) is in the actual persistent set (0 cells). Theorem 6.2 holds empirically — `steep_set ⊆ persistent_set`.

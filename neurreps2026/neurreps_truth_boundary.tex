...
\begin{figure}[t]
\centering
\includegraphics[width=0.74\linewidth]{schematic_coupling.pdf}
...
thing to argue about. The theorems do not say models err often,
the coupled point is neither strictly true nor strictly false, and
derived falsehood appears only in the stochastic dichotomy.
...
\label{thm:nonlinear}
Let $f$ be differentiable at a boundary point $x_0$ with nonzero
derivative $L$. Then every neighborhood of $x_0$ contains strictly
...
\begin{figure}[t]
\centering
\includegraphics[width=0.60\linewidth]{boundary_coupling.pdf}\\[2pt]
\includegraphics[width=0.60\linewidth]{endogenous_coupling.pdf}
...
disjoint split of the same states, giving 53, 84, 137, 80, and 147
kept paths. A path satisfies the separation premise when this field
sits on the correct side of one half at both endpoints. \tableref{tab:endogenous} and \figureref{fig:coupling} report
...
endogenous fields, every upper bound below its null median except
...
oddness. With the scalar Borsuk-Ulam analog and the first-order
nonlinear theory verified (\theoremref{thm:nonlinear}), what
remains is the full theorem for jointly odd axes
\citep{engels2025not}.

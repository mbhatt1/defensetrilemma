...
\theoremref{thm:approx}'s band separation, with the infimum of
...
oddness. We already verify the scalar Borsuk-Ulam analog on the
sphere and exercise nonlinear boundaries empirically. What remains
is the full theorem for jointly odd axes and a theory of nonlinear
boundaries \citep{engels2025not}.
